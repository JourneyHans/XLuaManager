...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp4(UnityEngine.WWW p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp5(System.IntPtr p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public XLua.LuaBase __Gen_Delegate_Imp6(int p0, XLua.LuaEnv p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp8(XLua.LuaEnv p0, XLua.ObjectTranslator p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp11(object p0, object p1, object p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public System.Collections.IEnumerator __Gen_Delegate_Imp12(object p0, object p1, object p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp14()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public string __Gen_Delegate_Imp15()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new System.Action<UnityEngine.WWW>(__Gen_Delegate_Imp4);
			}
		
		    if (type == typeof(System.Action<System.IntPtr>))
			{
			    return new System.Action<System.IntPtr>(__Gen_Delegate_Imp5);
			}
		
		    if (type == typeof(System.Func<int, XLua.LuaEnv, XLua.LuaBase>))
			{
			    return new System.Func<int, XLua.LuaEnv, XLua.LuaBase>(__Gen_Delegate_Imp6);
			}
			...
			{
			    return new System.Action<XLua.LuaEnv, XLua.ObjectTranslator>(__Gen_Delegate_Imp8);
			}
		
		    if (type == typeof(System.Func<object, bool>))
			{
			    return new System.Func<object, bool>(__Gen_Delegate_Imp9);
			}
