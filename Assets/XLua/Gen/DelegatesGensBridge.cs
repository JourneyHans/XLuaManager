...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public int __Gen_Delegate_Imp4(System.IntPtr p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public bool __Gen_Delegate_Imp5(System.IntPtr p0, int p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public object __Gen_Delegate_Imp6(System.IntPtr p0, int p1, object p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public byte[] __Gen_Delegate_Imp7(ref string p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp9(System.IAsyncResult p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp10(System.IntPtr p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public UnityEngine.GameObject __Gen_Delegate_Imp19(object p0, object p1, bool p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp23(object p0, UIManager.SortOrderLayer p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public UIManager.SortOrderLayer __Gen_Delegate_Imp24(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp28(object p0, UIManager.SortOrderLayer p1, object p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp31(object p0, object p1, object p2, object p3, object p4)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public byte[] __Gen_Delegate_Imp32(object p0, ref string p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new XLua.LuaDLL.lua_CSFunction(__Gen_Delegate_Imp4);
			}
		
		    if (type == typeof(XLua.ObjectCheck))
			{
			    return new XLua.ObjectCheck(__Gen_Delegate_Imp5);
			}
		
		    if (type == typeof(XLua.ObjectCast))
			{
			    return new XLua.ObjectCast(__Gen_Delegate_Imp6);
			}
		
		    if (type == typeof(XLua.LuaEnv.CustomLoader))
			{
			    return new XLua.LuaEnv.CustomLoader(__Gen_Delegate_Imp7);
			}
			...
			{
			    return new System.AsyncCallback(__Gen_Delegate_Imp9);
			}
		
		    if (type == typeof(System.Action<System.IntPtr>))
			{
			    return new System.Action<System.IntPtr>(__Gen_Delegate_Imp10);
			}
		
		    if (type == typeof(System.Func<int, XLua.LuaEnv, XLua.LuaBase>))
			{
			    return new System.Func<int, XLua.LuaEnv, XLua.LuaBase>(__Gen_Delegate_Imp11);
			}
		
		    if (type == typeof(System.Action<XLua.LuaEnv, XLua.ObjectTranslator>))
			{
			    return new System.Action<XLua.LuaEnv, XLua.ObjectTranslator>(__Gen_Delegate_Imp12);
			}
